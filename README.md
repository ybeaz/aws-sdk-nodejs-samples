...
### How to use npx together with exbuild

npx esbuild --bundle src/LoadBalancedFargateService.ts --outdir=dist --minify --sourcemap --platform=node
...
- [AWS Secretsmanager console](https://us-east-1.console.aws.amazon.com/secretsmanager/home) It is used to store safely GitHub personal access token for exaample
- [AWS S3 console](https://console.aws.amazon.com/s3/) It is used to display and control provision of the physical containers with files deployed
- [AWS CloudFormation console](https://console.aws.amazon.com/cloudformation/home) It is used to manage stacks for deployment
- [AWS CloudFront console](https://console.aws.amazon.com/cloudfront/v3/home#/distributions) It is used to see what instances are under distribution, visible outside
- [AWS Cloudtrail console](https://us-east-1.console.aws.amazon.com/cloudtrail/home) It is used to see internal errors
- [AWS Codepipeline console](https://us-east-1.console.aws.amazon.com/codesuite/codepipeline/pipelines) It is usd to display the state and control continuos integration and deployment (CI/CD)
- [AWS Lambda console](https://console.aws.amazon.com/lambda) It is used to configure, test, and manage Lambda functions
- [AWS API Gateway](https://console.aws.amazon.com/apigateway) It is used to configure API endpoints: resources, methods, params
- [AWS VPC Experience](https://console.aws.amazon.com/vpc) It is used to manage Virtual Private Cloud settings and cofiguration
- [AWS IAM console](https://console.aws.amazon.com/iamv2) It is used to mangage uses and resourses, their access rights, credentials, policies, roles
- [AWS Cognito identity](https://console.aws.amazon.com/cognito) It is used to create and manage login, passwords spaces for developing services, manage their credentials
- [AWS Codestar Connections Setting](https://console.aws.amazon.com/codesuite/settings/connections)
